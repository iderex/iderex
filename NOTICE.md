...
Everything published here is under one set of terms: the page and its prose
and the tooling that lints it alike, under the MIT terms in
[LICENSE](LICENSE). That file carries the warranty and liability disclaimer
this notice does not restate.
